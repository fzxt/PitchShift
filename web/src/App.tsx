...
export default function App() {
  ...
  useEffect(() => { const hashChange = () => { if (new URLSearchParams(location.hash.slice(1)).has('pitcher')) setSelection(initialSelection()); }; window.addEventListener('hashchange', hashChange); return () => window.removeEventListener('hashchange', hashChange); }, []);
